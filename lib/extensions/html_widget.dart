...
import 'package:mighty_fitness/components/PdfViewWidget.dart';
import 'package:mighty_fitness/components/VimeoEmbedWidget.dart';
import 'package:mighty_fitness/components/YouTubeEmbededWidget.dart';
...
class HtmlWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Text(
      ...
      style: TextStyle(color: color, fontSize: size?.toDouble() ?? 16),
    );
    /*return Html(
      data: postContent!,
