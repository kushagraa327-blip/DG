...
class AnimationConfiguratorClass extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final resolvedDuration = this.duration ?? animationConfiguration.duration;
    final resolvedDelay = this.delay ?? animationConfiguration.delay;
    final columnCount = animationConfiguration.columnCount;

    return AnimationExecutorClass(
      duration: resolvedDuration,
      delay: stagger(position, resolvedDuration, resolvedDelay, columnCount),
