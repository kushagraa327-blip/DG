...
import 'package:mighty_fitness/components/scheduled_component.dart';
...
class ScheduleScreenState extends State<ScheduleScreen> with AutomaticKeepAliveClientMixin {
  ...
  void initState() {
    ...
    // Convert IST to proper timezone identifier for API
    String apiTimezone = timezoneName == 'IST' ? 'Asia/Kolkata' : timezoneName;
    print('API Timezone: $apiTimezone');
