...
// Nutrition Tracking
const MEAL_ENTRIES_KEY = "MEAL_ENTRIES_KEY";
const NUTRITION_GOALS_KEY = "NUTRITION_GOALS_KEY";
const MAIN_GOAL_KEY = "MAIN_GOAL_KEY";
const AVATAR_MOOD_KEY = "AVATAR_MOOD_KEY";
const NUTRITION_STREAK_KEY = "NUTRITION_STREAK_KEY";

// IRA Chat & RAG System
const IRA_CONVERSATION_HISTORY_KEY = "IRA_CONVERSATION_HISTORY_KEY";
const IRA_USER_PREFERENCES_KEY = "IRA_USER_PREFERENCES_KEY";
const IRA_KNOWLEDGE_BASE_KEY = "IRA_KNOWLEDGE_BASE_KEY";
const IRA_CONTEXT_CACHE_KEY = "IRA_CONTEXT_CACHE_KEY";
...
const KEY_LAST_KNOWN_APP_LIFECYCLE_STATE = 'LAST_KNOWN_APP_LIFECYCLE_STATE';
const KEY_APP_BACKGROUND_TIME = 'APP_BACKGROUND_TIME';
